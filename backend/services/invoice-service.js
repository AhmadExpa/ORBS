...
const invoiceDisclaimer =
  "This invoice is generated by ElevenOrbits for managed services and related account charges. Service delivery, provisioning, renewals, cancellations, and support remain subject to ElevenOrbits service terms and any active Managed Service Agreement. Paid invoices confirm payment receipt only and do not transfer ownership of licensed software, third-party infrastructure, IP addresses, domains, or provider-managed resources. Taxes, duties, banking fees, currency conversion charges, and third-party processing fees remain the customer's responsibility unless explicitly stated otherwise.";
