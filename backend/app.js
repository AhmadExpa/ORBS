...
import { chatSupportRouter } from "./modules/chat-support/routes.js";
import { aiAdvisorRouter } from "./modules/ai-advisor/routes.js";
...
app.use("/api/v1/chat-support", chatSupportRouter);
app.use("/api/v1/ai-advisor", aiAdvisorRouter);
