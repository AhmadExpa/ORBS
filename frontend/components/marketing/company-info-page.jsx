  ...
  return (
    <main className="bg-white">
      <section className="relative border-b border-slate-200/80">
        ...
        <div className="relative mx-auto grid max-w-[1280px] gap-8 px-4 py-12 sm:px-6 sm:py-14 lg:grid-cols-[minmax(0,1fr)_360px] lg:py-16">
      ...
      <section className="border-b border-slate-200/80">
        <div className="mx-auto grid max-w-[1280px] gap-4 px-4 py-10 sm:px-6 md:grid-cols-3">
